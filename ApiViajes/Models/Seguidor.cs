...
namespace ViajesMvcNetCore.Models
{
    ...
    public class Seguidor
    {
        ...
        public UsuarioCompletoView UsuarioSeguidor { get; set; } // Relación con el usuario seguidor

        [ForeignKey("IdUsuarioSeguido")]
        public UsuarioCompletoView UsuarioSeguido { get; set; } // Relación con el usuario seguido
    }
}